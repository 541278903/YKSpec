...
Pod::Spec.new do |spec|
  ...
  spec.subspec 'YKRefresh' do |refresh|
        refresh.dependency 'YYK_BaseViews/BaseClass'
        refresh.dependency "MJRefresh"
        refresh.resources = "YYKPodLib_Sec/Resources/refresh_ani.gif","YYKPodLib_Sec/Resources/refresh_ani.gif"
        refresh.source_files = 'YYKPodLib_Sec/Classes/YKRefresh/*.{h,m}'
  end
  ...
  spec.subspec 'Exection' do |ex|
    ...
    ex.subspec 'Third' do |third|
        ...
        third.dependency "ReactiveObjC"
        third.dependency "Masonry"
        third.dependency "SDWebImage"
